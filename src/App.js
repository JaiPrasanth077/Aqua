...
<div class="ag-courses_box">
  {planets && planets.map((planet, index) => (
    ...
    <div className='pagination'>
      <button className="custom-btn btn-12" onClick={() => { fetchPrevPage() }} disabled={currentPage === 1}><span> Click </span><span>Previous Page</span></button>
      <button className="custom-btn btn-12" onClick={() => { fetchNextPage() }}><span> Click </span><span>Next Page</span></button>
